...
1.  **Type Safety (Future-Proofing):** While the current implementation is in JavaScript, all logic must follow strict typing patterns. If moving to TypeScript, use Zod for all input validation and define precise interfaces for BigQuery row structures.
